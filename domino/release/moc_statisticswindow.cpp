...
static constexpr auto qt_meta_stringdata_ZN16StatisticsWindowE = QtMocHelpers::stringData(
    "StatisticsWindow",
    "returnToMainMenu",
    "",
    "onHomeClicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN16StatisticsWindowE[] = {
...
Q_CONSTINIT const QMetaObject StatisticsWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16StatisticsWindowE.offsetsAndSizes,
    qt_meta_data_ZN16StatisticsWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16StatisticsWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<StatisticsWindow, std::true_type>,
...
void StatisticsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (StatisticsWindow::*)();
            if (_q_method_type _q_method = &StatisticsWindow::returnToMainMenu; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *StatisticsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16StatisticsWindowE.stringdata0))
...
// SIGNAL 0
void StatisticsWindow::returnToMainMenu()
{
